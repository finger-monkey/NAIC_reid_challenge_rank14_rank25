...
def main():
    ...
    FEATURE_6 = "/home/xiangan/dgreid/features/302"
    FEATURE_8 = "/home/xiangan/dgreid/features/118"
    ...
    query_feats = np.concatenate((query_feats_1, qf_2, qf_6, qf_8), axis=1)
    gallery_feats = np.concatenate((gallery_feats_1, gf_2, gf_6, gf_8), axis=1)
    ...
    with open('11_28_rerank3.json', 'w', encoding='utf-8') as f:
