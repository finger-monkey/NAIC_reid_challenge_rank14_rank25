...
class BNNeck_MGN(nn.Module):
    ...
    def __init__(self, num_classes, last_stride, model_path, model_name, pretrain_choice,
        ...
        self.bn4 = copy.deepcopy(bn)
        self.bn5 = copy.deepcopy(bn)
        self.bn6 = copy.deepcopy(bn)
        self.bn7 = copy.deepcopy(bn)
        self.bn8 = copy.deepcopy(bn)
    ...
    def forward(self, x):
        ...
        fg_p3_bn = self.bn3(fg_p3)
        f0_p2_bn = self.bn4(f0_p2)
        f1_p2_bn = self.bn5(f1_p2)
        f0_p3_bn = self.bn6(f0_p3)
