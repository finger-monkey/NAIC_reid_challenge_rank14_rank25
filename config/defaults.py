...
# Settings of focal loss
_C.SOLVER.FOCAL_LOSS = 'no'
_C.SOLVER.FOCAL_LOSS_GAMMA = 2
...
# Random Patch Prob
_C.INPUT.RANDOM_PATCH_PROB = 0.0
# Random Patch Max Area is 0.1667
_C.INPUT.RANDOM_PATCH_AREA = 0.1677
# data
...
_C.INPUT.HUE = 0.0
# rotate
_C.INPUT.ROTATE_PROB = 0.0
_C.INPUT.ROTATE_DEGREE = 0
# blur
_C.INPUT.GAUSSIAN_BLUR_PROB = 0.0
_C.INPUT.GAUSSIAN_BLUR_RADIUS = 0

# Triplet Loss
_C.SOLVER.TRIPLET_LOSS_WEIGHT = 1.0
