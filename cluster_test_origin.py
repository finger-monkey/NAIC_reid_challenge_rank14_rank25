...
def main():
    ...
    testA_gallery_info = pickle.load(open(
        '/home/xiangan/dgreid/features/apex_003_test_origin/gallery_feature.feat', 'rb')
    )
    testA_query_info = pickle.load(open(
        '/home/xiangan/dgreid/features/apex_003_test_origin/query_feature.feat', 'rb')
    )
    ...
    for query, clean_list in tqdm(cleaned_rank_dict_testA.items()):
        ...
        output_name = os.path.join("/data/xiangan/reid_extra/extra_5",
                                   "%d_c1_%s" % (count, query))
