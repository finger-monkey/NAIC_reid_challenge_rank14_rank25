...
def main():
    ...
    gallery_info = pickle.load(open('features_flip/%s/gallery_a_feature.feat' % args.name, 'rb'))
    query_info = pickle.load(open('features_flip/%s/query_a_feature.feat' % args.name, 'rb'))
    ...
    with open('submission_flip_%s.json' % args.name, 'w', encoding='utf-8') as f:
